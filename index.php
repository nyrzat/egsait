...
elseif (count($params) < 2) {
    $routes = [
        ...
        'aviatorization' => 'pages/aviatorization.php',
        'avtoration' => 'pages/avtoration.php',
        'clothes_order' => 'pages/clothes_order.php',
        'oversize' => 'pages/oversize.php',
        'main' => 'pages/main.php',
        'logaut' => 'pages/logaut.php',
    ];
